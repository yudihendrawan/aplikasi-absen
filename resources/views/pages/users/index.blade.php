<x-layouts.app :title="__('Daftar Karyawan')">
    <div class="overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-gray-800 p-4">
        <h1 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Daftar Karyawan</h1>
        <form method="GET" action="{{ route('users.index') }}" class="mb-4 w-full flex flex-wrap gap-4 items-end">
    ...
    <script>
        ...
        const clearFilter = document.querySelector('a[href="{{ route('users.index') }}"]');
