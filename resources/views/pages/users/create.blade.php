        ...
        <div class=" ">
            ...
            <form action="{{ route('users.store') }}" method="POST"
                ...
                <div class="flex items-center justify-end">
                    <button type="submit"
                        class="text-white bg-blue-700 active:scale-95 transition-all duration-200 hover:bg-blue-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Submit') }}</button>
                    <button type="button" onclick="window.location='{{ route('users.index') }}'"
                        class="ml-2 text-gray-700 bg-gray-200 hover:bg-gray-300 active:scale-95 transition-all duration-200 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">{{ __('Cancel') }}</button>
                </div>
            </form>
        </div>
    </div>
